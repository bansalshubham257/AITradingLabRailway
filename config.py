...
class Config:
    ...
    ACCESS_TOKE = os.getenv('ACCESS_TOKEN', '.eyJzdiOiIyWEJSUFMiLqdGkiOiI2NDFkYTVlZjBjpZW50IjpmYWLOiJ1ZGFwaAiOjE3NDMDB9.Ra7Bclq3ysxWNmi7oJol_1mcgz1sCK7WWgFG-59ZFmM')
