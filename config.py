...
class Config:
    ...
    ACCESS_TOKEN = os.getenv('ACCESS_TOKEN', '.eyJzdiOiIyWEJSUFMiLqdGkiOiI2NDFkYTVlZjBjpZW50IjpmYWLCJpc3MiOiJ1ZGFwaS1nYXRld2F52UiLCJleHAiOjE3NDM3MTc2MDB9.Ra7Bclq3ysxWNmi7oJol_1mcgz1sCK7WWgFG-59ZFmM')
